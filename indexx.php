...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-group label i { margin-right: 8px; color: #60A5FA; }
        .form-group input {
...
<div class="container">
    ...
    <form id="loginForm">
        <div class="form-group">
            ...
            <input type="email" name="email" id="email" placeholder="admin@sekolah.com" required>
        </div>
        <div class="form-group">
